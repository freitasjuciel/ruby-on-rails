...
class TrainingsControllerTest < ActionController::TestCase
  ...
  test "should create training" do
    assert_difference('Training.count') do
      post :create, training: { name: @training.name, repetitions: @training.repetitions, series: @training.series, time: @training.time }
    end
  ...
  test "should update training" do
    patch :update, id: @training, training: { name: @training.name, repetitions: @training.repetitions, series: @training.series, time: @training.time }
    assert_redirected_to training_path(assigns(:training))
  end
